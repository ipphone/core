...
namespace ContactPoint
{
    public class UILineWrapper
    {
        ...
        public ICall Call
        {
            get { return _call; }
            set {
                Trace.TraceInformation("Set call with sessionId '" + value?.SessionId + "' on UILineWrapper" + _controlButton.Text);
        ...
        public bool Active
        {
            get { return _active; }
            set {
                Trace.TraceInformation("Activate UILineWrapper" + _controlButton.Text);
        ...
        void Call_OnStateChanged()
        {
            ...
            Trace.TraceInformation("New call state on UILineWrapper" + _controlButton.Text + ", new state: " + SipHelper.SipCallStateDecode(_call?.State ?? CallState.NULL));
        ...
        void RefreshUI()
        {
            //Logger.LogNotice("Refreshing UI on UILineWrapper" + this._controlButton.Text);
